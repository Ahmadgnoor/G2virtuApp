...
class G2virtuAnimation extends StatefulWidget {
  const G2virtuAnimation({super.key});

  @override
  State<G2virtuAnimation> createState() => _G2virtuAnimationState();
}

class _G2virtuAnimationState extends State<G2virtuAnimation>
  ...
  void _startAnimations() async {
    ...
    // Step 4: Create fading effect and show G2virtu logo
