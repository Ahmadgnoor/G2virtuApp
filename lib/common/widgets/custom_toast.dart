...
void fluttertoast(Color textColor, Color backgroundColor, String message,
...
Future<void> flutterSimpleToast(
...
Future<void> showErrorToast(Response<dynamic>? response) async {
  if (response?.data['message'] != null) {
    ...
    await flutterSimpleToast(Colors.white, Colors.black,
        'Something Went Wrong! Please re-login or contact support@g2virtu.com');
  }
}
